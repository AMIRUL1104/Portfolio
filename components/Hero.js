...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full max-w-container-max mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 md:py-20 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 lg:gap-16 overflow-hidden"
    >
      {/* Background Glow */}
      <div
        ref={glowRef}
